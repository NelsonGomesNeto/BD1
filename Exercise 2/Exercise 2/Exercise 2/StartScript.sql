...
CREATE DATABASE  hospital /*!40100 DEFAULT CHARACTER SET utf8 */;
go
USE [hospital];
...
CREATE INDEX [fkcodcidade_idx] ON medico ([codcidade]);
CREATE INDEX [fkespecialidade_idx] ON medico ([especialidade]);
CREATE INDEX [fknumeroA_idx] ON medico ([numeroA]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE INDEX [fkcodcidade_idx] ON paciente ([codcidade]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE INDEX [fkcrg_idx] ON consulta ([rg]);
CREATE INDEX [fkccoddoenca_idx] ON consulta ([coddoenca]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE INDEX [fkfcodcidade_idx] ON funcionario ([codcidade]);
/*!40101 SET character_set_client = @saved_cs_client */;
